...
import { Github, Linkedin, Twitter, Mail, Code2, ArrowUpRight, Globe, Zap } from 'lucide-react';
    ...
    <footer className="bg-[#050505] border-t border-white/5 pt-16 pb-8 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          {/* 1. Branding - Ocupa todo el ancho en móvil para impacto */}
          <div className="col-span-2 md:col-span-1 border-b md:border-none border-white/5 pb-8 md:pb-0">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-white font-bold text-xl tracking-tighter italic">
                DEV<span className="text-blue-500 not-italic">STUDIO</span>
              </span>
            </div>
            ...
            <div className="flex gap-3">
              {[Github, Linkedin, Twitter].map((Icon, i) => (
                <a key={i} href="#" className="p-2.5 bg-white/5 rounded-xl border border-white/10 hover:border-blue-500/50 transition-all">
                  <Icon size={16} className="text-gray-400 hover:text-blue-500" />
                </a>
              ))}
            </div>
          </div>

          {/* 2. Links Rápidos - 2 columnas en móvil para ahorrar espacio */}
          <div className="col-span-1">
            <h4 className="text-blue-500 font-mono text-[10px] uppercase tracking-[0.2em] mb-4">Explorar</h4>
            <ul className="space-y-3">
              {['Servicios', 'Portfolio', 'Contacto'].map((item) => (
                <li key={item}>
                  <a href={`#${item.toLowerCase()}`} className="text-gray-400 hover:text-white text-xs transition-colors flex items-center group">
                    {item} <ArrowUpRight size={10} className="ml-1 opacity-0 group-hover:opacity-100 transition-all" />
                  </a>
                </li>
              ))}
            </ul>
          ...
          {/* 3. Tech Stack - Muy visual en móvil */}
          <div className="col-span-1">
            ...
            <ul className="space-y-3 text-gray-400 text-xs">
              ...
              <li className="flex items-center gap-2"><div className="w-1 h-1 bg-purple-500 rounded-full"/> Node / Go</li>
            </ul>
          </div>

          {/* 4. Contact Card - Estilo "Glass" en móvil */}
          <div className="col-span-2 md:col-span-1">
            <div className="bg-white/[0.03] border border-white/10 p-4 rounded-2xl backdrop-blur-md">
              ...
              <a href="mailto:hola@devstudio.com" className="text-gray-300 text-xs break-all hover:text-blue-400 transition-colors block mb-1">
                hola@devstudio.com
              </a>
